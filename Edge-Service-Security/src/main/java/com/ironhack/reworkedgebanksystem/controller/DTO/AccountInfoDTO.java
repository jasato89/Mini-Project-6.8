...
public class AccountInfoDTO {
    ...
    public AccountInfoDTO(Money balance, AccountHolderInformationDTO accountHolder, AccountHolderInformationDTO secondaryAccountHolder, LocalDateTime creationDate) {
